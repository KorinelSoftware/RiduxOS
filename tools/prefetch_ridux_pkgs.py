...
4. Starting from the user-requested top-level package set
   (wayfire, wf-shell, waybar, firefox, xorg-minimal, dbus, ...), build the
...
-----
    python3 tools/prefetch_ridux_pkgs.py \\
        ...
        --repo latest \\
        --top wayfire wf-shell waybar foot thunar firefox xorg-minimal dbus \\
...
DEFAULT_TOP = [
    ...
    "pkg",
    # Wayland desktop: Wayfire first, with software/Pixman as the stable
    # first renderer and X11 left as fallback.
    "wayfire",
    "wf-shell",
    "waybar",
    "wcm",
    ...
    "dejavu",
    "noto-basic",
    # X11/browser fallback dependencies of the Ridux UI.
    "firefox",
    "xorg-minimal",
    "xinit",
    "xauth",
